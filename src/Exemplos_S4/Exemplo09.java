...
public void actionPerformed(ActionEvent e)
{
   ...
   if((Tx1.getText().equals("Marcos")) && (Sx.getText().equals("Profes")))
      JOptionPane.showMessageDialog(null,Tx1.getText() + " VOC  ACERTOU A SENHA");
   else
   {
      if(Vezes == 3)
      {
         JOptionPane.showMessageDialog(null,"VOC  GASTOU SUAS 3 CHANCES ! TCHAAAAAUUUUU !");
	        System.exit(0);
	     }
      else
	        JOptionPane.showMessageDialog(null,"SENHA ERRADA ! PRESTE ATEN  O E TENTE NOVAMENTE !");
   }
}
}